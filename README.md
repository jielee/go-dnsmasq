# go-dnsmasq
[![Latest Version](https://img.shields.io/github/release/jielee/go-dnsmasq.svg?maxAge=60)][release]
[![Github All Releases](https://img.shields.io/github/downloads/jielee/go-dnsmasq/total.svg?maxAge=86400)]()
[![Docker Pulls](https://img.shields.io/docker/pulls/jielee/go-dnsmasq.svg?maxAge=86400)][hub]
[![License](https://img.shields.io/github/license/jielee/go-dnsmasq.svg?maxAge=86400)]()

[release]: https://github.com/jielee/go-dnsmasq/releases
[hub]: https://hub.docker.com/r/jielee/go-dnsmasq/
...
Download the binary for your OS from the [releases page](https://github.com/jielee/go-dnsmasq/releases/latest).
...
Docker Hub trusted builds are [available](https://hub.docker.com/r/jielee/go-dnsmasq/).

```sh
docker run -d -p 53:53/udp -p 53:53 jielee/go-dnsmasq:latest
```
